...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <div class="container">
        <h1 class="jumbotron-heading">Order List</h1>
    </div>
</section>
<div class="container"> 
	<div class="list-group container">
		<c:forEach var="it" items="${i}">
			<a href="user_order_details?b=${it}"><div class="list-group-item list-group-item-warning">
				<strong>Order no. </strong> <c:out value="${it}"/>
			</div></a>
		</c:forEach>
	</div>
</div>
