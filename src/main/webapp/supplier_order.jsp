...
<div class="container">
	...
	<thead>
		...
		<c:forEach var="it" items="${i}">
			<tr>
				<td><c:out value="${it.getOrder_id()}"/></td>
				<td><c:out value="${it.getUser_id()}"/></td>
				<td><c:out value="${it.getItem_id()}"/></td>
				<td><c:out value="${it.getItem_name()}"/></td>
				<td><c:out value="${it.getPrice()}"/></td>
				<td><c:out value="${it.getItem_count()}"/></td>
			</tr>
		</c:forEach>
</table>
</div>
